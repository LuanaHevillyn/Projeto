...
<nav class="navbar">
    <div class="container-fluid">
        ...
        <ul class="nav nav-underline">
            ...
            <li class="nav-item">
                <a class="nav-link active"  media="only screen" style="color: white; font-family: 'Montserrat'; font-weight: 700;" aria-current="page" href="#">Usuário</a>
            </li>
        </ul>
        ...
        <table class="table table-bordered">
            <thead>
                ...
                <tbody>
                    ...
                    <?php include_once  '../consultar/usuario_c.php' ?>
