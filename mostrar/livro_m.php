...
<nav class="navbar">
    <div class="container-fluid">
        ...
        <ul class="nav nav-underline">
            ...
            <li class="nav-item">
                <a class="nav-link active" media="only screen" style="color: white; font-family: 'Montserrat'; font-weight: 700;" aria-current="page" href="#">Livro</a>
            </li>
            <li class="nav-item">
        ...
        <table class="table table-bordered">
            <thead>
                ...
                <tbody>
                    ...
                    <?php include_once  '../consultar/livro_c.php' ?>
